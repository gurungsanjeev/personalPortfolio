...
const Navbar = (props) => {
    return (
        <>
            <nav
                className={`flex-col sm:flex-row md:flex-row lg:flex-row bg-${props.mod
                    } text-${props.mod === "light" ? "dark" : "light"}`}
            >
                ...
                <div className="logo">
                    <ScrollNavLink
                        ...
                        activeClass="active"
                    >
                        <h1 className=" sm: justify-center font-semibold text-2xl ">
                ...
                <div>
                    ...
                    <ul id="nav"
                        className="
                        flex items-center 
                        sm:text-red-500 md:text-green-400 lg:text-yellow-500
                        gap-3 
                    ...
                    >
                        ...
                        <li>
                            <a
                                href="mailto:gurungsanjeev05@gmail.com"
                                className="bg-blue-600 text-white 
                            rounded-md
                             flex justify-center align-middle text-center  md,lg:{pr-7 pl-7 pt-2 pb-2}"
                            >
                                Mail
                            </a>
                        </li>
